...
export default function ContentNavigator({ userId, setUserId, onUnauthenticate }) {
  const renderProfilePage = () => (
    <ProfilePage userId={userId} setUserId={setUserId} onUnauthenticate={onUnauthenticate} />
  );

  const renderSearchPage = ({ navigation }) => (
    <SearchPage navigation={navigation} setUserId={setUserId} />
  );

  const renderFriendsPage = ({ navigation }) => (
    <FriendsPage navigation={navigation} setUserId={setUserId} />
  );
